  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center mesh-gradient-bg relative overflow-hidden bg-transparent pt-32 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-96 lg:mb-[28rem]">
          ...
          <div className="flex flex-col items-start text-left space-y-8 z-10 order-2 lg:order-1">
            ...
            >
              <button
                ...
                className="pill-button px-8 py-4 bg-[#521D07] text-white text-xl font-bold hover:bg-[#FFA51F] hover:scale-105 transition-all shadow-[4px_4px_0px_#A47A2D]"
              >
                View Projects
              </button>
              <button
                onClick={() => scrollToSection('contact')}
                className="pill-button px-8 py-4 border-4 border-[#521D07] text-[#521D07] dark:text-[#E2E8F0] dark:border-[#E2E8F0] text-xl font-bold hover:bg-[#521D07] hover:text-white transition-all"
              >
                Contact Me
              </button>
            </motion.div>
...
<br></br>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-48 lg:mt-64 mb-48 lg:mb-64">
          <div className="sticker-card bg-white dark:bg-[#252220] p-8 center-content border-4 border-[#A47A2D] dark:border-[#A47A2D]">
            <Layers className="w-12 h-12 text-[#A47A2D] mb-4 mx-auto" />
          ...
          <div className="sticker-card bg-white dark:bg-[#252220] p-8 center-content border-4 border-[#A47A2D] dark:border-[#A47A2D]">
            <Award className="w-12 h-12 text-[#A47A2D] mb-4 mx-auto" />
          ...
          <div className="sticker-card bg-white dark:bg-[#252220] p-8 center-content border-4 border-[#A47A2D] dark:border-[#A47A2D]">
            <TrendingUp className="w-12 h-12 text-[#A47A2D] mb-4 mx-auto" />
...
<br></br><br></br>
        ...
        <div className="max-w-4xl mx-auto mt-24 lg:mt-32">
          ...
          <div className="sticker-card bg-white dark:bg-[#252220] p-10 border-4 border-[#A47A2D] dark:border-[#A47A2D] relative overflow-hidden group">
            {/* Background Graphic */}
            <div className="absolute -right-10 -top-10 opacity-5 dark:opacity-10 transform rotate-12 transition-transform duration-700 group-hover:scale-110 group-hover:rotate-6">
              <TrendingUp className="w-64 h-64 text-[#521D07] dark:text-[#E2E8F0]" />
            </div>
            ...
            <p className="text-[24px] font-bold text-[#521D07] dark:text-[#B8B0A6] mb-8 relative z-10">
            ...
            <button
              onClick={() => scrollToSection('projects')}
              className="pill-button px-10 py-4 bg-[#A47A2D] dark:bg-[#A47A2D] text-white dark:text-[#1A1715] text-[24px] inline-flex items-center gap-3 hover:bg-[#FFA51F] dark:hover:bg-[#FFA51F] transition-colors relative z-10"
            >
