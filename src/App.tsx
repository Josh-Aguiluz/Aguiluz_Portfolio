            ...
            <div className="hidden md:flex items-center gap-1">
              {navLinks.map((link) => (
                <MagneticButton
                  ...
                  style={{ fontFamily: 'Michroma, sans-serif' }}
                  className={`px-4 py-2 text-[14px] md:text-[16px] font-black uppercase transition-all rounded-full border-none ${
            ...
            <div className="px-4 sm:px-6 py-8 space-y-3">
              {navLinks.map((link, index) => (
                <motion.button
                  ...
                  onClick={() => scrollToSection(link.id)}
                  style={{ fontFamily: 'Michroma, sans-serif' }}
                  className={`block w-full text-center px-6 py-4 text-[24px] sm:text-[32px] font-black uppercase rounded-[20px] transition-all ${
                    activeSection === link.id
                      ? 'text-[#A47A2D]'
